...
public class Step {
    ...
    public void setList(java.util.List<de.caegroup.jaxb.process.List> value) {
        this.list = value;
    }

    public void setInit(java.util.List<Init> value) {
        this.init = value;
    }

    public void setCommit(java.util.List<Commit> value) {
        this.commit = value;
    }
