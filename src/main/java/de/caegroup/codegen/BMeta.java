...
implements Serializable, Cloneable
{
	...
	public void genCode(String type)
	{
		...
		if(type.matches("process"))
		{
			...
			content.add("# generated by codegen-core at "+timestamp);
			content.add("# a tool from prozesskraft");
			content.add("my $procname = \"" + this.parent.getName() + "\";");
		...
		else
		{
			...
			content.add("# generated by codegen-core at "+timestamp);
			content.add("# a tool from prozesskraft");
			content.add("my $procname = \"[% procname %]\";");
