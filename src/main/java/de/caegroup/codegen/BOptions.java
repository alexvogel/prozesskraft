...
implements Serializable, Cloneable
{
	...
	public void genCode(String type)
	{
		...
		if(type.matches("process"))
		{
			...
			content.add("				'instancedir'  => {'reihenfolge' => '12', 'minoccur' => '0', 'maxoccur' => '1', 'definition' => 'string', 'check'=>'', 'default' => '', 'textfordefault' => './<prozess>_<version>_<random>', 'text1' => '=DIR', 'text2' => 'directory for instancedata. use an empty or a nonexistent one'},");
