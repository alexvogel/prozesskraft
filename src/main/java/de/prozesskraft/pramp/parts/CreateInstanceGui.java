...
//		gd_composite.minimumHeight = 10;
	    ...
	    labelIntro.setText("you are about to create an instance of a process. Do not move, copy or delete instance data by hand. Use move, clone and delete of application 'pradar'.");
