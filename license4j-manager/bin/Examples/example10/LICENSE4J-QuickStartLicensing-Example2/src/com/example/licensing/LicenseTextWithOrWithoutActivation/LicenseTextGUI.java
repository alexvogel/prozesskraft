/*
 * License Text GUI file, for license input, validation, activation and display details.
 */
package com.example.licensing.LicenseTextWithOrWithoutActivation;
 ...
 *
 */
public class LicenseTextGUI extends javax.swing.JDialog {
     ...
     */
    /**
     * This is the file in which license text is saved. It is in user's home
     * directory on disk. You may save it on database or in any other file if
     * you like.
     */
    private final String licenseFileOnDisk = System.getProperty("user.home") + File.separator + "MyApplicationLicenseTextFile.lic";

    /* License object; validate method return this object. */
    private License licenseObject;

    /* LicenseTextGUI constructor. */
    public LicenseTextGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         ...
         * valid, requires activation and not activated.
         */
    ...
    public License checkLicense() {
        try {
             ...
             * from file.
             */
            String licenseTextString = FileUtils.readFileToString(new File(licenseFileOnDisk));
            ...
            Logger.getLogger(LicenseTextGUI.class.getName()).log(Level.SEVERE, null, ex);
        }

        /**
         * If there is no license text file, then it returns null here.
         */
        return null;
    }
        ...
        if (licenseObject != null) {
            switch (licenseObject.getValidationStatus()) {
                case LICENSE_VALID:
                    if (licenseObject.isActivationCompleted()) {
                    ...
                    } else if (licenseObject.isActivationRequired()) {
                        ...
                        /**
                         * License key is valid, it requires activation and
                         * activation is not completed so display "activate"
                         * button.
                         */
                        ...
                        // activation is not required so disable activate button.
                        activatejButton.setVisible(false);
                    }
    ...
    private void initComponents() {
        ...
        changeProductLicensejButton = new javax.swing.JButton();
        ...
        changeProductLicensejButton.setText("Change Product License");
        changeProductLicensejButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                changeProductLicensejButtonActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(progressjLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 179, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        .addComponent(activatejButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(changeProductLicensejButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {activatejButton, changeProductLicensejButton, closejButton});

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void changeProductLicensejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeProductLicensejButtonActionPerformed
        ...
        // Show open dialog to customer to select license text file.
        int r = jFileChooser1.showOpenDialog(this);
        if (r == JFileChooser.APPROVE_OPTION) {
            // read license string from file.
            String licenseTextString = "";
            try {
                licenseTextString = FileUtils.readFileToString(jFileChooser1.getSelectedFile());
            } catch (IOException ex) {
                Logger.getLogger(LicenseTextGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            if (temporaryLicenseObject.getValidationStatus() == ValidationStatus.LICENSE_VALID) {
                ...
                try {
                     ...
                     * string to file.
                     */
                    FileUtils.writeStringToFile(new File(licenseFileOnDisk), licenseTextString);
                } catch (IOException ex) {
                    Logger.getLogger(LicenseTextGUI.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    }//GEN-LAST:event_changeProductLicensejButtonActionPerformed
    ...
    private void activatejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_activatejButtonActionPerformed
        ...
        SwingWorker<License, Void> worker = new SwingWorker<License, Void>() {
            ...
            protected void done() {
                try {
                    ...
                    if (temporaryLicenseObject.getActivationStatus() == ActivationStatus.ACTIVATION_COMPLETED) {
                        ...
                        try {
                             ...
                             */
                            FileUtils.writeStringToFile(new File(licenseFileOnDisk), licenseObject.getLicenseString());
                        } catch (IOException ex) {
                            Logger.getLogger(LicenseTextGUI.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                changeProductLicensejButton.setEnabled(true);
            }
        ...
        changeProductLicensejButton.setEnabled(false);
    }//GEN-LAST:event_activatejButtonActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton activatejButton;
    private javax.swing.JButton changeProductLicensejButton;
